...
class ARApp {
    constructor() {
        ...
        this.currentVideoSrc = 'changi-chroma.mp4'; // 현재 영상 소스
    ...
    async init() {
        console.log('========================================');
        console.log('    AR Vision - 3 Layer System');
        console.log('========================================');
    ...
    setupOriginMarker() {
        ...
        // 바닥 그리드 (2m x 2m, 20칸)
        this.floorGrid = new THREE.GridHelper(2, 20, 0x00ff88, 0x004422);
